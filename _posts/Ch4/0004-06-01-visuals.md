...
Background are useful for setting a scene but can sometimes clog up a panel and distract the reader. They also slow the pacing because they give the reader more to examine within the panel. For this reason, most action panels drop the background out completely. You can also drop out a background to add special emphasis to a big moment or a shocking reveal. Here’s [a fantastic video](https://www.youtube.com/watch?v=KbMj9f0mcBA) by Strip Panel Naked about background usage.
